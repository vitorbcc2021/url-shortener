...
import { shortenUrl, goToUrl, editUrl, deleteUrl, getUrlList, delRecruiterUrls } from '../controllers/url-controller.js'
...
router.delete('/delRecruiterUrls', authenticate, authorize(['client', 'admin']), delRecruiterUrls)
